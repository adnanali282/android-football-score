...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.score.setText(Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt
                (COL_AWAY_GOALS)));
        ...
        //Log.v(FetchScoreTask.LOG_TAG,mHolder.home_name.getText() + " Vs. " + mHolder.away_name
        // .getText() +" id " + String.valueOf(mHolder.match_id));
    ...
    public Intent createShareForecastIntent(String ShareText)
    {
        ...
        shareIntent.setType("mText/plain");
